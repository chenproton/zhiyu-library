...
import { type AbilityItem, type AbilityPoint, type LevelMapping } from '@/lib/types'
...
interface AbilityItemSectionProps {
  ...
  onItemChange: (item: AbilityItem) => void
  disabled?: boolean
}
...
export function AbilityItemSection({
  ...
  const handlePointChange = (updatedPoint: AbilityPoint) => {
